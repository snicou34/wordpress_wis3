<?php get_header(); ?>
    ...
    <main id="main" class="site-main" role="main">
       ...
       <h1><?php the_title(); ?></h1>
        ...
        <?php if ($telephone = get_field('telephone')) : ?>
            <div class="telephone">
                <?php echo gettext($telephone); ?>
            </div>
        <?php endif; ?>

        <?php if ($adresse = get_field('adresse-etablissement')) : ?>
            <div class="adresse">
                <?php echo gettext($adresse); ?>
            </div>
        <?php endif; ?>
